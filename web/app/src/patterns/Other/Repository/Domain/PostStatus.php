...
namespace Dallask\Patterns\Other\Repository\Domain;

/**
 * Like PostId, this is a value object which holds the value of the current
 * status of a Post. It can be constructed either from a string or int and is
 * able to validate itself. An instance can then be converted back to int or
 * string.
 */
class PostStatus {
  ...
  /**
   * there is a reason that I avoid using __toString() as it operates outside
   * of the stack in PHP and is therefor not able to operate well with
   * exceptions
   */
