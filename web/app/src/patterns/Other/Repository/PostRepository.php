...
/**
 * This class is situated between Entity layer (class Post) and access object
 * layer (Persistence).
 *
...
class PostRepository {
   ...
   *
   * @param \Dallask\Patterns\Other\Repository\Persistence $persistence
   */
  ...
  public function findById(PostId $id): Post {
    try {
      ...
      throw new \OutOfBoundsException(
        sprintf('Post with id %d does not exist', $id->toInt()), 0, $e
      );
    }
